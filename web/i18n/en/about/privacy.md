...
titty.tools' privacy policy is simple: we don't collect or store anything about you.
what you do is solely your business, not ours or anyone else's.

these terms are applicable only when using the official titty.tools instance.
...
when using saving functionality, titty.tools may need to proxy or remux/transcode files.
...
on an unmodified & official titty.tools instance,
...
as long as titty.tools' source code is not modified.
...
of active titty.tools users, fully anonymously. no identifiable information about
you or your requests is ever stored. all data is anonymized and aggregated.
we self-host and manage the [plausible instance](https://{env.PLAUSIBLE_HOST}/) that titty.tools uses.
