...
## сжимайте файлы на своём устройстве

вкладка сжать уменьшает видео, аудио и изображения локально. выберите пресет качества или свой максимальный размер файла — файлы перекодируются на вашем устройстве через ffmpeg, ничего не загружается, и результат всегда меньше целевого размера.
