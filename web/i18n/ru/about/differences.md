...
вкладка конвертер превращает локальные файлы в другие форматы без загрузки на сервер. перетащите файл, выберите формат, и конвертация произойдёт на вашем устройстве через ffmpeg, imagemagick, pandoc и mupdf, скомпилированные в WebAssembly. видео, аудио, изображения и документы — всё поддерживается (включая зашифрованные xod-файлы pdftron и документы xps/pdf/epub), и ваши файлы никогда не покидают ваш компьютер.
